			...
			<View style={style.imageWrapper}>
				...
				>
					{this.props.callbackUrl != null ? (
						<Image
							source={{
								uri : this.state.uploaded_photo ? this.state.uploaded_photo : this.props.callbackUrl
							}}
						...
						<Image
							source={{
								uri : 'https://cdn.pixabay.com/photo/2017/08/16/00/29/add-person-2646097_960_720.png'
							}}
							style={{ width: 130, height: 130, borderRadius: 50 }}
						/>
					)}
